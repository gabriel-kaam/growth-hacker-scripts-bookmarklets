...
const selectors = {
	...
	button_archive: '[data-testid="feed_container_non_empty_state"] [data-testid="feed_container_non_empty_state"] + .wbloks_1 [role="button"] [role="button"]',
	button_archive_confirm: '._aac-._aad6',
	check_post: '[data-testid="feed_container_non_empty_state"] [data-testid="feed_container_non_empty_state"] [data-bloks-name="ig.components.Icon"]',
};
...
const STARTING_URL = 'https://www.instagram.com/your_activity/photos_and_videos/posts';
